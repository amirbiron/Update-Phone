...
async function analyzeTextWithClaude(query, searchResults) {
  if (searchResults.length === 0) {
      return `## 🔍 לא נמצאו דיווחי משתמשים

לאחר חיפוש מעמיק עם מספר אסטרטגיות חיפוש, לא נמצאו דיווחים ספציפיים של משתמשים על הדגם **${query}**. 

**סיבות אפשריות:**
• העדכון זמין אך משתמשים עדיין לא דיווחו על החוויה
• הדיונים מתקיימים בפלטפורמות אחרות (קבוצות טלגרם, פייסבוק מקומיות)
• המכשיר פחות פופולרי בקהילות דוברות אנגלית

**📊 מידע על סטטוס עדכונים רשמי:**
לבדיקת הסטטוס הרשמי של עדכוני אנדרואיד למכשיר שלכם:
• [מעקב עדכוני Xiaomi אנדרואיד 15](https://miuirom.org/updates/xiaomi-android-15)
• [מעקב עדכוני Redmi אנדרואיד 15](https://miuirom.org/updates/redmi-android-15)
• [מעקב עדכוני POCO אנדרואיד 15](https://miuirom.org/updates/poco-android-15)

**המלצות:**
• בדקו את הסטטוס הרשמי בקישורים למעלה
• חפשו בקבוצות טלגרם מקומיות של המכשיר
• המתינו מספר שבועות נוספים לקבלת דיווחים נוספים
• בדקו עדכונים במכשיר: הגדרות > עדכון מערכת`;
  }
